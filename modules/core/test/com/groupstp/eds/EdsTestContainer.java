...
public class EdsTestContainer extends TestContainer {

    public EdsTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/groupstp/eds/app.properties",
    ...
    public static class Common extends EdsTestContainer {

        public static final EdsTestContainer.Common INSTANCE = new EdsTestContainer.Common();
